                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`px-4 py-1.5 rounded-full text-sm font-bold ${department.isActive
                  ...
                  <div className="space-y-3">
                    {department.employees.slice(0, 10).map((employee, index) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <span className={`px-3 py-1.5 rounded-full text-xs font-bold ${employee.status === 'ACTIVE'
