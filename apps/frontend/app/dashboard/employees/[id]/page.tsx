...
import {
    ...
    CheckCircle, AlertTriangle, Info, Shield, GraduationCap, CreditCard, DollarSign
} from 'lucide-react';
...
export default function EmployeeDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [activeSection, setActiveSection] = useState<'profile' | 'documents' | 'salary' | 'activity'>('profile');
