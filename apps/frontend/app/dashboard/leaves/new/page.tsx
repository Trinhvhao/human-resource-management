...
export default function NewLeavePage() {
  ...
  const onSubmit = async (data: LeaveFormData) => {
    try {
      ...
      toast.success('Tạo đơn nghỉ phép thành công! Đơn của bạn đang chờ phê duyệt.');
      ...
      {isHROrAdmin ? (
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-slate-700">Không có quyền truy cập</h2>
            <p className="text-slate-500">HR/Admin không thể tạo đơn nghỉ phép cho bản thân.</p>
            <p className="text-slate-500">Vui lòng quay lại trang danh sách để duyệt đơn của nhân viên.</p>
            <button
              onClick={() => router.push('/dashboard/leaves')}
              className="mt-4 px-6 py-2 bg-brandBlue text-white rounded-lg hover:bg-blue-700 transition-colors"
            >
              Quay lại danh sách
            </button>
          </div>
