      ...
      >
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-6">
            ...
            <span className="text-xs font-bold text-brandLightBlue uppercase tracking-wider">Thư viện 2026</span>
          </div>
  ...
  const items = [
    {
      ...
      desc: "Hình ảnh hoạt động công ty, team building, và các sự kiện đặc biệt được lưu trữ và chia sẻ dễ dàng.",
